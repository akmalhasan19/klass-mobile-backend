-- Seed tencent V4 Flash pricing into `llm_price_catalog`.
-- These values match the OpenRouter pricing for tencent/hy3:free
...
VALUES
    ('tencent', 'tencent/hy3:free', 0.10000000, 0.40000000, NOW(), TRUE)
