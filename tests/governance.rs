...
fn test_exhausted_decision_interpret_is_deny() {
    let d = exhausted_decision("interpret", "minimax", "minimax-m3");
    assert!(!d.allowed);
...
fn test_exhausted_decision_respond_is_degrade() {
    let d = exhausted_decision("respond", "minimax", "minimax-m3");
    assert!(d.allowed);
...
fn test_ledger_record_input_completed() {
    let input = LedgerRecordInput {
        ...
        primary_provider: "minimax".to_string(),
        model: "minimax-m3".to_string(),
        requested_model: "minimax-m3".to_string(),
        ...
        attempted_providers: vec!["minimax".to_string()],
...
fn test_ledger_record_input_failure() {
    let input = LedgerRecordInput {
        ...
        attempted_providers: vec!["minimax".to_string(), "minimax".to_string()],
        upstream_request_id: None,
        provider_response_id: None,
        provider_model_version: None,
        finish_reason: None,
