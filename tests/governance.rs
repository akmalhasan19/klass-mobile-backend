...
fn test_exhausted_decision_interpret_is_deny() {
    let d = exhausted_decision("interpret", "xiaomi", "mimo-v2.5-pro");
    assert!(!d.allowed);
...
fn test_exhausted_decision_respond_is_degrade() {
    let d = exhausted_decision("respond", "xiaomi", "mimo-v2.5-pro");
    assert!(d.allowed);
...
fn test_ledger_record_input_completed() {
    let input = LedgerRecordInput {
        ...
        requested_model: "mimo-v2.5-pro".to_string(),
...
fn test_ledger_record_input_failure() {
    let input = LedgerRecordInput {
        ...
        attempted_providers: vec!["xiaomi".to_string(), "xiaomi".to_string()],
        upstream_request_id: None,
        provider_response_id: None,
        provider_model_version: None,
        finish_reason: None,
