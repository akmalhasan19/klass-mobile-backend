...
mod tests {
    ...
    fn test_respond_result_defaults() {
        ...
        let result = RespondResult {
            ...
            llm_model: Some("gemini/gemini-2.5-flash-lite".to_string()),
            llm_used: true,
            fallback_used: false,
    ...
    fn test_respond_result_fallback() {
        ...
        let result = RespondResult {
            ...
            llm_used: false,
            fallback_used: true,
            response_headers: respond_headers("openrouter", "gemini/gemini-2.5-flash-lite", false, true),
            latency_ms: None,
        };
    ...
    fn test_respond_result_cache_hit() {
        ...
        let result = RespondResult {
            ...
            llm_used: true,
            fallback_used: false,
            response_headers: respond_headers("openrouter", "gemini/gemini-2.5-flash-lite", true, false),
    ...
    fn test_respond_headers() {
        let h = respond_headers("openrouter", "gemini/gemini-2.5-flash-lite", true, false);
        ...
        let h2 = respond_headers("openrouter", "gemini/gemini-2.5-flash-lite", false, true);
