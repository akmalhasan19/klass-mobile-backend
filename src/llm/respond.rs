...
mod tests {
    ...
    fn test_respond_result_defaults() {
        ...
        let result = RespondResult {
            ...
            llm_model: Some("deepseek/deepseek-v4-flash".to_string()),
            llm_used: true,
            fallback_used: false,
    ...
    fn test_respond_result_fallback() {
        ...
        let result = RespondResult {
            ...
            llm_used: false,
            fallback_used: true,
            response_headers: respond_headers("openrouter", "deepseek/deepseek-v4-flash", false, true),
            latency_ms: None,
        };
    ...
    fn test_respond_result_cache_hit() {
        ...
        let result = RespondResult {
            ...
            llm_used: true,
            fallback_used: false,
            response_headers: respond_headers("openrouter", "deepseek/deepseek-v4-flash", true, false),
    ...
    fn test_respond_headers() {
        let h = respond_headers("openrouter", "deepseek/deepseek-v4-flash", true, false);
        ...
        let h2 = respond_headers("openrouter", "deepseek/deepseek-v4-flash", false, true);
